...
// router
//   .route('/:userId')
//   .get(auth('getUsers'), validate(productValidation.getUser), productController.getUser)
//   .patch(auth('manageUsers'), validate(productValidation.updateUser), productController.updateUser)
//   .delete(auth('manageUsers'), validate(productValidation.deleteUser), productController.deleteUser);
